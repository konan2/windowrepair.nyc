...
<div class="px-0 px-sm-3"><img class="alignnone size-full wp-image-21" src="https://test.windowrepair.nyc/wp-content/uploads/2024/04/img1.png" alt="" width="540" height="565" /></div>
</div>
</div>
</section>
...
<section id="quality-services" class="quality-services">
    ...
    <div id="swiper-best-quality" class="swiper-best-quality container">
        <div class="quality-services__wrapper row row-cols-md-3 swiper-wrapper">
...
<section id="front-banner-mirrors" class="contrast-banner">
<div class="contrast-banner__container container-xl container">
    <div class="row">
        ...
        <div class="contrast-banner__image col-md-7 px-0 px-sm-3">
            <img class="alignnone size-full wp-image-32" src="https://test.windowrepair.nyc/wp-content/uploads/2024/04/windows.png" alt="" width="754" height="365" />
        </div>
    </div>
</div>
</section>
...
<section id="best-solutions" class="best-solutions">
    <div class="container-xl text-center container">
...
<div class="our-services__list row row-cols-1 row-cols-md-4">

    <article class="filter-card mb-3 mb-md-0" data-type="type1">
...
<article class="filter-card mb-3 mb-md-0" data-type="type2">
<div class="our-services__list-item">
...
<article class="filter-card" data-type="type2">
<div class="our-services__list-item">
...
<section id="windows-banner" class="windows-banner contrast-banner container-fluid">
        ...
        <div class="windows-banner__wrapper row">
            ...
            <div class="windows-banner__decor col-6 col-md-4 justify-content-end order-2 order-md-1">
                <img src="<?php echo get_template_directory_uri() ?>/img/windows-1.png" alt="">
            </div>
